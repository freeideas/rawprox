...
def main():
    ...
    try:
        ...
        # This is an architectural requirement - verify through code review
        # Network forwarding must never wait for disk writes
...
"""
        ...
        assert result.returncode == 0, f"Code review failed with return code {result.returncode}"  # $REQ_SIMPLE_018
        assert 'VERDICT: PASS' in result.stdout, f"Architectural requirement not satisfied:\n{result.stdout}"  # $REQ_SIMPLE_018
